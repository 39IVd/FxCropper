...
enum class Edge private constructor() {
    ...
    fun set_Coordinate(coordinate: Float) {
        this.coordinate = coordinate
    }


    fun get_Coordinate(): Float {
    ...
    fun snapOffset(imageRect: Rect): Float {
        ...
        when (this) {
            LEFT -> newCoordinate = imageRect.left.toFloat()
            TOP -> newCoordinate = imageRect.top.toFloat()
            RIGHT -> newCoordinate = imageRect.right.toFloat()
            BOTTOM -> newCoordinate = imageRect.bottom.toFloat()
        }
    ...
    fun isOutsideMargin(rect: Rect, margin: Float): Boolean? {
        ...
        when (this) {
            ...
            TOP -> result = this.coordinate - rect.top.toFloat() < margin
            RIGHT -> result = rect.right.toFloat() - this.coordinate < margin
            BOTTOM -> result = rect.bottom.toFloat() - this.coordinate < margin
        }
